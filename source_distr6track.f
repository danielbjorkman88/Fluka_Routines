...
*     @@@                                                            @@@
*     @@@   Last change by F. Cerutti on 26-Sep-14                   @@@
*     @@@                                                            @@@
*     @@@@@@@@@@@                                            @@@@@@@@@@@
*
*
...
*
      INTEGER NIN
      PARAMETER (NINMAX = 10000000)! Max. # of particles (lines) in file       
...
*  |  @@@                                                            @@@
         IF ( LSVERB ) THEN
             WRITE( 84, * ) "# ### Particle distribution ###"
             WRITE( 84, * ) "#"
             WRITE( 84, * ) "# Primary particle ID = ",IJBEAM
         END IF
*  |  @@@                                                            @@@
...
*            PBAUX = PBAUX / 1.0D+03
*  |  @@@                                                            @@@
*  |  @@@ Example II (SixTrack format from L. Lari, collim. team)    @@@
*  |  @@@                                                            @@@
*  |  @@@   Column 1: sample (not used)                              @@@
*  |  @@@   Column 2: particle (not used)                            @@@
*  |  @@@   Column 3: x  (in mm)                                     @@@
*  |  @@@   Column 4: y  (in mm)                                     @@@
*  |  @@@   Column 5: x' (in mrad)                                   @@@
*  |  @@@   Column 6: y' (in mrad)                                   @@@
*  |  @@@   Column 7: energy (not used)                              @@@
*  |  @@@   Column 8: s-coord (not used)                             @@@
*  |  @@@   Column 9: turn (not used)                                @@@
*  |  @@@   Column 10: x-norm (not used)                             @@@
*  |  @@@   Column 11: y-norm (not used)                             @@@
*  |  @@@   Column 12: xp-norm (not used)                            @@@
*  |  @@@   Column 13: yp-norm (not used)                            @@@
*  |  @@@   Column 14: ampl-x (not used)                             @@@
*  |  @@@   Column 15: ampl-y (not used)                             @@@
*  |  @@@                                                            @@@
*            READ( LINE,* ) IFORGE, JFORGE, XAUX, YAUX, XPAUX, YPAUX
*            XAUX = XAUX/TENTEN
*            YAUX = YAUX/TENTEN
*            ZAUX = ZERZER
*            XPAUX = XPAUX/1.D+03
...
*            PBAUX = PBEAM
*  |  @@@                                                            @@@
*  |  @@@ Example III (MADX format from L. Stoel, SPS-LSS2-septum)   @@@
*  |  @@@                                                            @@@
*  |  @@@   Column 1: number                                         @@@
*  |  @@@   Column 2: turn                                           @@@
*  |  @@@   Column 3: Ptot  (in GeV/c)                               @@@
*  |  @@@   Column 4: x  (in cm)                                     @@@
*  |  @@@   Column 5: y  (in cm)                                     @@@
*  |  @@@   Column 6: cx                                             @@@
*  |  @@@   Column 7: cy                                             @@@
...
*  |  @@@   Column 11: PY                                            @@@
*  |  @@@   Column 12: PT                                            @@@
            READ( LINE,* ) IPART, ITURN, PBAUX, XAUX, YAUX, XPAUX, YPAUX
            ZAUX = ZBEAM
*  |  @@@                                                            @@@
*  |  @@@                                                            @@@
...
*  |  @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
*  |  @@@                                                            @@@
*  |  @@@ Deriving direction cosines from x' and y'                  @@@
* lse ->            DIRNOR = SQRT(ONEONE+XPAUX**2+YPAUX**2)
* lse ->            XPAUX = XPAUX / DIRNOR
* lse ->            YPAUX = YPAUX / DIRNOR
* lse ->            ZPAUX = ONEONE / DIRNOR
