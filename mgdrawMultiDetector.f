...
*=== mgdraw ===========================================================*
*                                                                      *
      SUBROUTINE MGDRAW ( IJ, PLA, ICODE, MREG )
...
*                                                                      *
     ...
     &          'FORMATTED' )
         WRITE(73,100) "Particle", "From Reg", "To Reg", "X", "Y",
     &         "Z", "X'", "Y'", "Z'", "E", "PTOT"
      END IF
      IF ( JTRACK .GE. -6 ) THEN
         AMASS = AM ( JTRACK )
...
*TPX1	  
      IF (MREG .EQ. 734 .AND. NEWREG .EQ. 1565) THEN
         WRITE (73,200) JTRACK, MREG, NEWREG, XSCO, YSCO, ZSCO,
     &         CXTRCK, CYTRCK, CZTRCK, ETRACK, PTOT
      END IF
*TPX4	  
      IF (MREG .EQ. 1418 .AND. NEWREG .EQ. 1566) THEN
         WRITE (73,200) JTRACK, MREG, NEWREG, XSCO, YSCO, ZSCO,
     &         CXTRCK, CYTRCK, CZTRCK, ETRACK, PTOT
      END IF
*TPX5
      IF (MREG .EQ. 1452 .AND. NEWREG .EQ. 1567) THEN
         WRITE (73,200) JTRACK, MREG, NEWREG, XSCO, YSCO, ZSCO,
     &         CXTRCK, CYTRCK, CZTRCK, ETRACK, PTOT
      END IF
*TPX6
      IF (MREG .EQ. 1453 .AND. NEWREG .EQ. 1568) THEN
         WRITE (73,200) JTRACK, MREG, NEWREG, XSCO, YSCO, ZSCO,
     &         CXTRCK, CYTRCK, CZTRCK, ETRACK, PTOT
      END IF
*TPX7
      IF (MREG .EQ. 1453 .AND. NEWREG .EQ. 1569) THEN
         WRITE (73,200) JTRACK, MREG, NEWREG, XSCO, YSCO, ZSCO,
     &         CXTRCK, CYTRCK, CZTRCK, ETRACK, PTOT
      END IF
*TPX8
      IF (MREG .EQ. 1426 .AND. NEWREG .EQ. 1570) THEN
         WRITE (73,200) JTRACK, MREG, NEWREG, XSCO, YSCO, ZSCO,
     &         CXTRCK, CYTRCK, CZTRCK, ETRACK, PTOT
      END IF
*TPX9
      IF (MREG .EQ. 829 .AND. NEWREG .EQ. 1571) THEN
         WRITE (73,200) JTRACK, MREG, NEWREG, XSCO, YSCO, ZSCO,
     &         CXTRCK, CYTRCK, CZTRCK, ETRACK, PTOT
      END IF
*TPX11
      IF (MREG .EQ. 734 .AND. NEWREG .EQ. 1572) THEN
         WRITE (73,200) JTRACK, MREG, NEWREG, XSCO, YSCO, ZSCO,
     &         CXTRCK, CYTRCK, CZTRCK, ETRACK, PTOT
      END IF		  
 100  FORMAT ("#", A19, 20(1X,A19))
 200  FORMAT(I20,I19,I19, 10E20.11)
      RETURN
*
*======================================================================*
*                                                                      *
